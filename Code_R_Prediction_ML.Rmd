...
# On enleve les descripteurs qui ne respectent pas la normalité des résidus pour les moyennes ajustées soit :
...
# Tableau sans les descripteurs trop fortement corrélés
```{r}
...
```
# Tableau sans descripteurs qui ne respect pas normalité des résidus et les descripteurs avec une trop forte corrélation
```{r}
